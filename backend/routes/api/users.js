...
router.get(
  "/:userId/posts",
  [requireAuth, userExists, validateFriends],
  async (req, res) => {
    const { id: userId } = req.user;
...
router.get(
  "/:userId/friends",
  [requireAuth, userExists, validateFriends, usersFriendsExist],
  async (req, res) => {
    const { friends } = req;
...
//Get all comments from a user (unused)
router.get(
  "/:userId/comments",
  [requireAuth, userExists, validateFriends],
  async (req, res) => {
...
//Get a users Events(unused)
router.get(
  "/:userId/events",
  [requireAuth, validateFriends],
  async (req, res) => {
    const { userId } = req.params;
