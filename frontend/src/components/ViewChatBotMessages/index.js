  ...
  return (
    <div id="messages">
          ...
          if (message.user) {
            return (
              <div className="user-message-container" key={message.id}>
                <p className="user-message-language">
            ...
            if (!message.engine) {
              return (
                <div className="bot-message-container" key={message.id}>
                  <p className="message-language">
                    {languages[message.language]}
                  </p>
                  <div className="bot-message">{message.body}</div>
                </div>
              );
            } else {
              if (message.data) {
      ...
      {messages &&
        ...
        Object.values(messages)[Object.values(messages).length - 1].user ===
          true && (
          <div className="bot-message-container">
